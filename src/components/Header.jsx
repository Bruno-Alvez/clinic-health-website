...
const dropdownLinks = {
  Dermatologia: [
    { title: "Limpeza de Pele", href: "/dermatologia/limpeza" },
    { title: "Peelings", href: "/dermatologia/peelings" },
  ],
  Tricologia: [
    { title: "Análise Capilar", href: "/tricologia/analise" },
    { title: "Tratamento Queda", href: "/tricologia/queda" },
  ],
  "Medicina Clínica e Hormonal": [
    { title: "Terapia Hormonal", href: "/medicina/terapia" },
    { title: "Check-up Completo", href: "/medicina/checkup" },
  ],
};
